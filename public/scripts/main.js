...
artists.set(1,{id:1, name: 'akka', bio:"60 words dolor sit amet, consectetur adipiscing elit. Phasellus est urna, pulvinar in blandit eu, consequat lacinia turpis. Nulla facilisi. Vivamus volutpat nisi vel aliquam convallis. Etiam sed est sit amet ipsum varius faucibus at vitae ligula. Nulla laoreet feugiat tristique. Nullam vitae arcu sit amet elit porta malesuada. Praesent sit amet turpis et turpis congue tincidunt. Vestibulum dolor augue.", image: 'images/Akka.png', sc: 1231299577})
...
artists.set(3,{id:3,name: 'Buttechno (GER)', bio:"80 words dolor sit amet, consectetur adipiscing elit. Quisque in orci eget sem tincidunt blandit. Aenean efficitur leo non tortor condimentum, id auctor nisl lacinia. In hac habitasse platea dictumst. Maecenas vitae fermentum erat, in pulvinar eros. Nulla ac suscipit urna. Aenean pharetra velit ac finibus pellentesque. Pellentesque accumsan consectetur odio, in lacinia lacus porta non. Etiam sed tempus nunc. Fusce venenatis elit elementum justo lobortis iaculis. Pellentesque mollis mollis justo, a pharetra mauris ultrices in. Sed a massa volutpat.", image: 'images/artist.png', sc: 1231299577})
artists.set(4,{id:4,name: 'Cured Pink (LIVE)', bio:"Rhythm. Sound. Musical histories of Jamaica and the UK provided in illusive, spaced out trips. Pulling from all corners of dub, jungle, bass and beyond, Ryan Hunter (Midnight Tenderness) and Rory McPike (Rings Around Saturn) will have no issues getting us where we need to go.", image: 'images/Cured_Pink.png', sc: 1231299577})
artists.set(5,{id:5,name: 'D-Grade & imbi (HYBRID)', bio:"The powerhouse duo of Rainbow Chan (also Chunyin) and Alex Ward (Moon Holiday) offer a brash, irreverent and unpretentious DIY delivery of pop leaning electro soundscapes. Effortless and intimate, driven by ethic, immune to bullshit.", image: 'images/artist.png', sc: 1231299577})
artists.set(6,{id:6,name: 'Darcy Justice', bio:"Sydney’s favourite do has been shouting out loud his local scene through his co-run label Ken Oath and party series Rimbombo, as well as his new label and radio program, Best Effort (Sky Lounge). A superior digger and mood setter. Pulling from all corners, he can set almost any scene.", image: 'images/Darcy_Justice_02.png', sc: 1231299577})
artists.set(7,{id:7,name: 'DJ Paramat', bio:"It’s rare to leave a Fabrics set without feeling as though you’ve delved into some sort of lowkey existential pondering. Their emotionally charged sets, full of pulsing, textural progressions, offer a consistent energy and pace that pull you along with it, no questions asked.", image: 'images/DJ_Paramat.png', sc: 1231299577})
artists.set(8,{id:8,name: 'Emelyne', bio:"Prepped for any occasion, and always on the textural tip. One of the masterminds behind the infamous Pickle crew out of Canberra, FB Perimeter knows how to put out a niche spread for the masses. Balanced for both the body and mind.", image: 'images/Emelyne.png', sc: 1231299577})
artists.set(9,{id:9,name: 'Facta & K-Lone (UK)', bio:"Fuelled by high energy, higher calibre selects, DJ Sarah and Georgia Bird display a defiant drive built on a deep appreciation of breaks, jungle and the tougher edge of the Motor City sound. Sliding through with Drexciyan precision, this pair loosen and transport dancefloors with relative ease. Non stop bop.", image: 'images/artist.png', sc: 1231299577})
artists.set(10,{id:10,name: 'Genie', bio:"IV Drip is a Sydney based DJ who won’t be limited by genre bounds, but holds a high affiliation for glitchy electro and breaks. She’s a regular fixture in the Sydney rave scene and has played support for Delta Funktionen, Madam X and Nite Fleit.", image: 'images/artist.png', sc: 1231299577})
artists.set(11,{id:11,name: 'ioki (LIVE)', bio:"Fuelled by high energy, higher calibre selects, DJ Sarah and Georgia Bird display a defiant drive built on a deep appreciation of breaks, jungle and the tougher edge of the Motor City sound. Sliding through with Drexciyan precision, this pair loosen and transport dancefloors with relative ease. Non stop bop.", image: 'images/artist.png', sc: 1231299577})
artists.set(12,{id:12,name: 'Jossy Mitsu (UK)', bio:"Nat James’ obsession with collecting records leans toward the left-field and experimental. Recent supports include Simo Cell and Moopie, as well as mixes for Apsis & Steeplejack that have only left us wanting more.", image: 'images/artist.png', sc: 1231299577})
artists.set(13,{id:13,name: 'Mike Midnight', bio:"The powerhouse duo of Rainbow Chan (also Chunyin) and Alex Ward (Moon Holiday) offer a brash, irreverent and unpretentious DIY delivery of pop leaning electro soundscapes. Effortless and intimate, driven by ethic, immune to bullshit.", image: 'images/Mike_Midnight.png', sc: 1231299577})
artists.set(14,{id:14,name: 'Moopie', bio:"Always across all things experimental, Shoeb Ahmad (Tangents, Spartak, Agency) is hard to pin down. Consistently offering performances with a considered ambiance and subtle political urgency, Shoeb will be delivering a unique performance not to be missed.", image: 'images/artist.png', sc: 1231299577})
artists.set(15,{id:15,name: 'Nat James', bio:"It’s rare to leave a Fabrics set without feeling as though you’ve delved into some sort of lowkey existential pondering. Their emotionally charged sets, full of pulsing, textural progressions, offer a consistent energy and pace that pull you along with it, no questions asked.", image: 'images/Nat_James.png', sc: 1231299577})
artists.set(16,{id:16,name: 'Natalia', bio:"Always across all things experimental, Shoeb Ahmad (Tangents, Spartak, Agency) is hard to pin down. Consistently offering performances with a considered ambiance and subtle political urgency, Shoeb will be delivering a unique performance not to be missed.", image: 'images/Natalia_02.png', sc: 1231299577})
artists.set(17,{id:17,name: 'salllvage (LIVE)', bio:"Always across all things experimental, Shoeb Ahmad (Tangents, Spartak, Agency) is hard to pin down. Consistently offering performances with a considered ambiance and subtle political urgency, Shoeb will be delivering a unique performance not to be missed.", image: 'images/artist.png', sc: 1231299577})
artists.set(18,{id:18,name: 'Setwun', bio:"Prepped for any occasion, and always on the textural tip. One of the masterminds behind the infamous Pickle crew out of Canberra, FB Perimeter knows how to put out a niche spread for the masses. Balanced for both the body and mind.", image: 'images/artist.png', sc: 1231299577})
artists.set(19,{id:19,name: 'Tangela', bio:"Recently joining forces having both released on Sydney’s Black Wattle, this pair knows how to map out a truly unique sonic journey. Traversing ambient jaunts with ethereal steps and overwhelming hypnosis, Tom & Liam will bring in the rise, Sunday morning.", image: 'images/artist.png', sc: 1231299577})
artists.set(20,{id:20,name: 'Tim Boyd', bio:"Always across all things experimental, Shoeb Ahmad (Tangents, Spartak, Agency) is hard to pin down. Consistently offering performances with a considered ambiance and subtle political urgency, Shoeb will be delivering a unique performance not to be missed.", image: 'images/artist.png', sc: 1231299577})
artists.set(21,{id:21,name: 'Yikes', bio:"Prepped for any occasion, and always on the textural tip. One of the masterminds behind the infamous Pickle crew out of Canberra, FB Perimeter knows how to put out a niche spread for the masses. Balanced for both the body and mind.", image: 'images/Yikes_02.png', sc: 1231299577})
